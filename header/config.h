...
inline std::string DB_name = "video_search_engine";
...
inline double frame_difference_threshold = 0.0005;   // Threshold of treating two adjacent frames as different frames 
